    ...
    <div className="mx-auto max-w-6xl px-6 py-16 space-y-10">
        ...
        {service.steps.map((step) => (
          ...
          >
            ...
            <div className="mt-2 text-sm text-slate-600">
              Выполняем по чек-листу, фиксируем статус и сообщаем сроки.
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-slate-900 px-6 py-8 text-white shadow-sm">
        <div className="grid gap-6 md:grid-cols-2 md:items-center">
          <div>
            <h2 className="text-2xl font-semibold">Нужна диагностика?</h2>
            <p className="mt-2 text-sm text-slate-200">
              Оставьте контакты — свяжемся и согласуем выезд или доставку в сервис.
            </p>
          </div>
          <Link
            href="/contacts"
