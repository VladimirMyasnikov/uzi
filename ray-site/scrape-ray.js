// Скрипт парсит каталог ray-systems.ru и складывает данные/картинки в папку ray-catalog
...
const ROOT = "https://ray-systems.ru";
const START_URL = `${ROOT}/catalog/`;
const OUT_DIR = path.join(__dirname, "ray-catalog");
